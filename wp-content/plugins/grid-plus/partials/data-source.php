...
$order_by = isset($grid['grid_data_source']['order_by'] ) ? $grid['grid_data_source']['order_by'] : '';
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <select id="source_type" class="form-control grid-col-md-6"
                            ...
                            <option value="posts" <?php echo ($source_type === 'posts') ? 'selected' : ''; ?>><?php esc_html_e('Post items', 'grid-plus'); ?></option>
                            <option value="taxonomies" <?php echo ($source_type === 'taxonomies') ? 'selected' : ''; ?>><?php esc_html_e('Post taxonomies', 'grid-plus'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
