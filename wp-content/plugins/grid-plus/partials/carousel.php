    ...
    <div class="form-groups" id="form_layout_pagination">
        ...
        <div class="col-md-6 col-xs-12">
            ...
            <div class="form-group" data-depend-control="layout_show_nav" data-depend-value="true">
                <label for="layout_carousel_nav_position" class="col-xs-4 control-label"><?php esc_html_e('Navigation Position') ?></label>
                <div class="col-xs-8">
            ...
            <div class="form-group" data-depend-control="layout_show_nav" data-depend-value="true">
                <label for="layout_carousel_nav_style" class="col-xs-4 control-label"><?php esc_html_e('Navigation Style') ?></label>
                <div class="col-xs-8">
