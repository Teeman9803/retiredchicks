...
if (!class_exists('Grid_Plus')) {
    class Grid_Plus
    {
        ...
        function get_all_skins() {
            ...
            $grid_plus_skins = array(
                ...
                array(
                    ...
                    'template' => G5PLUS_GRID_DIR . 'skins/content-overlay.php'
                ),
                array(
                    'name'    => 'Podcast Grid',
                    'slug'     => 'podcast-grid',
                    'template' => G5PLUS_GRID_DIR . 'skins/podcast-grid.php'
                ),
                array(
        ...
        function grid_plus_shortcode_register_script()
        {
            ...
            wp_register_script('justified-gallery', G5PLUS_GRID_URL . 'assets/lib/justified-gallery/justified-gallery.min.js',array(), false, true);
