...
if ( !class_exists( 'PP_Smart_Archive_Page_Remove' ) ) { 
  ...
  class PP_Smart_Archive_Page_Remove {
    ...
    function admin_js() {
      ...
      wp_enqueue_script( 'smart-archive-page-remove-ui', plugins_url( 'assets/js/smart-archive-page-remove-ui.js', $this->_file ), array( 'jquery' ), $this->version, true );
