...
<strong>The [smart Archive Page Remove](https://petersplugins.com/free-wordpress-plugins/smart-archive-page-remove/) Plugin allows you to remove Archive Pages automatically generated by WordPress</strong>
...
More detailed information about the smart Archive Page Remove plugin can be found in the [Plugin Manual](https://petersplugins.com/docs/smart-archive-page-remove/). For support check the [Support Forum](https://wordpress.org/support/plugin/smart-archive-page-remove/).
